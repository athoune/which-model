...
│ 33 models  ·  29 with benchmark scores  ·  4 searched, no citable source  ·  6         │
│ awaiting an agent  ·  verbosity baseline 200 output tokens                             │
╰────────────────────────────────────────────────────────────────────────────────────────╯
...
│                                                                                        │
│ source: aa = Artificial Analysis · seed = curated seed · override = human/agent · n/a  │
│ = searched, nothing citable · mixed = several of these                                 │
